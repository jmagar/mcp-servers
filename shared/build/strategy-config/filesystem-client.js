 ...
 */
export class FilesystemStrategyConfigClient {
    configPath;
    configPathPromise;
    options;
    constructor(options = {}) {
    ...
    matchesPrefix(hostname, pathname, prefix) {
        ...
        for (const line of lines) {
            ...
            if (trimmed.startsWith('|') && trimmed.endsWith('|')) {
                if (!headerFound) {
                    ...
                    if (trimmed.toLowerCase().includes('prefix') &&
